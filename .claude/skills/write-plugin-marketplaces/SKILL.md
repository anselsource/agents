---
name: write-plugin-marketplaces
description: Guide for creating and distributing Claude Code plugin marketplaces. Use when creating a marketplace.json, hosting a marketplace, distributing plugins to teams, configuring plugin sources (GitHub, npm, git URL), setting up release channels, managing private repositories, or troubleshooting marketplace issues.
---

Copied from https://code.claude.com/docs/en/plugin-marketplaces on 2026-02-28.
